# 1_model_race_interaction.R
# Bayesian model of race interaction using JAGS software on high-performance-computer
# July 2021
...
pretest_final = mutate(pretest_final, 
                       ...
                       race1 = as.numeric(Race=='Other'), # reference = 'white'
                       race2 = as.numeric(Race=='Black'),
...
formula = clicked ~ trt2_c + trt2_l + race1 + race2 + int1 + int2 + int3 + int4 + age_c + male + Education + trumppercent 
